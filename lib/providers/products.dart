...
class ProductsProvider with ChangeNotifier {
  ...
  Future<void> addUpdateProduct(Product product) {
    final url =
        Uri.https('shop-app-91095-default-rtdb.firebaseio.c', '/products.json');
    return http
        .post(url,
            body: jsonEncode({
              'title': product.title,
        ...
        .then((response) {
      String newId = jsonDecode(response.body)['name'];
